...
Der Median-Schnitt ist ein Sortierverfahren für n-dimensionale Daten und der meistbenutzte Farbreduktions-Algorithmus. Er unterteilt die Farbwerte anhand des Medians iterativ in Gruppen ähnlicher Werte. Nach der Lokalisation der Gruppen werden deren Farbwerte typischerweise gemittelt um den repräsentierenden Farbwert zu erhalten. Bei der Farbreduktion wird dies so oft wiederholt bis die Anzahl der Gruppen der Anzahl der gewünschten Farben entspricht. Der Median  wird mit Hilfe der euklidischen Distanz berechnet:
\begin{equation*}
