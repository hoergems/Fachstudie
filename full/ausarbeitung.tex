...
Für andere Objekte, wie Kugeln und Bonddrähte, wird der nichtdeterministische RANSAC-Algorithmus und ein auf das Problem zugeschnittener, selbstgewählter Ansatz untersucht.
Im letzten Abschnitt werden nun die betrachteten Verfahren einander gegenübergestellt und anschließend eine Empfehlung bezüglich des Einsatzes in der Praxis geggeben.
\else
\section*{Abstract}
\fi
\cleardoublepage
